...
Для структуры с использованием ES 6 модулей в структуре файлов также нужно создать отдельные директории
...
Особенности:
- Для запуски сборки использовать команду `npm run dev`
- Для корректной работы плагина gulp-webpcss требуется установить дополнительно плагин `webp-converter@2.2.3`
- Для создания спрайтов в текущей версии сборки требуется выполнить команду `npm run svgSprites`
